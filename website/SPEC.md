...
- Hero: logo, tagline "Start now and become an Angular Expert!", CTAs: _Get Started_, _Latest challenge_, _GitHub star_.
...
1. **Search**: Starlight ships Pagefind search. v1 without search, or include a simple client-side search over titles? _(default: include a lightweight title/description search in the sidebar — cheap to do)_
